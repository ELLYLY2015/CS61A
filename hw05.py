...
class VendingMachine:
    ...
    def restock(self, number):
        self.stock += number
        return ('{} {} {} {}'.format('Current', self.name, 'stock:', self.stock))
    def deposit(self, amount):
        if self.stock == 0:
            return ('{}. {}{}{}'.format('Machine is out of stock', 'Here is your $', amount, '.'))
        else:
            self.balance += amount
    ...
    def vend(self):
        ...
        if diff < 0:
            return ('{}{} {}{}'.format('You must deposit $', abs(diff), 'more', '.'))
        elif diff > 0:
            self.balance = 0
            self.stock -= 1
            return ('{} {} {}{} {}{}'.format('Here is your', self.name,'and $', diff, 'change','.'))
        else:
            self.balance = 0
            self.stock -= 1
