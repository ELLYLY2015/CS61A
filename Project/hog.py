...
def is_swap(player_score, opponent_score):
    ...
    return check(player_score) == check(opponent_score)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    cur_player = 0
    first = True
    num_rolls0, num_rolls1 =  0, 0
    while score0 < goal and score1 < goal:
        compare = num_rolls0 - num_rolls1
        if cur_player == 0:
            num_clone0 = num_rolls0
            num_rolls0 = strategy0(score0, score1) 
            score0 += take_turn(num_rolls0, score1, dice)
            if abs(num_rolls0 - num_clone0) == 2:
                score0 += 3
        elif cur_player == 1:
            num_clone1 = num_rolls1
            num_rolls1 = strategy1(score1, score0)
            score1 += take_turn(num_rolls1, score0, dice)
            if abs(num_rolls1 - num_clone1) == 2:
                score1 += 3 
